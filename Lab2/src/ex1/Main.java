...
public class Main {
	public static void main(String[] args) {
		...
		Application a2 = new Application("A1", LocalDate.of(2019, Month.JUNE, 1), Languages.JAVA);
		Application a3 = new Application("A1", LocalDate.of(2019, Month.JUNE, 1), Languages.JAVA);

		Essay e1 = new Essay("E1", LocalDate.parse("2019-06-01"), Topics.ALGORITHMS);

		s1.setPreferinte(a1, a2, a3);
